...
describe('RentalCardsController', () => {
  ...
  it('should get rental card by id', async () => {
    ...
    expect(controller.getById(card)).toEqual(new RentalCardOutputDto(card));
  });
  ...
  it('should register card', async () => {
    ...
    ).toEqual(new RentalCardOutputDto(card));
  ...
  it('should unregister rental cards', async () => {
    const card = rentalCardEntityMock();
    expect(await controller.delete(card)).toEqual(new RentalCardOutputDto(card));
